...
typedef bool (*ufsm_guard_func_t) (void *m, struct ufsm_transition  *t);
typedef void (*ufsm_action_func_t) (void *m, struct ufsm_transition *t);
typedef void (*ufsm_entry_exit_func_t) (void *m, struct ufsm_state *s);
