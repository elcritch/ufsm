...
bool Guard(void *m, ufsm_trans_t *s)
{
    return true;
}

void DoAction(void *m, ufsm_trans_t *t)
{
}

void eD(void *m, ufsm_state_t *s)
{
    flag_eD = true;
}

void eC(void *m, ufsm_state_t *s)
{
    flag_eC = true;
}
...
void final(void *m, ufsm_trans_t *t)
{
    flag_final = true;
}
